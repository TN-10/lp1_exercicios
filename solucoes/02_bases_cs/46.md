...
"c, b, a", pois o Método é passado como referência, ou seja, quando queremos
que este (método) use e possivelmente altere a nossa variável. Dará, então, 
uma nova referência ao array `a`, colocando o último elemento do array original,
na posição 0, o segundo na posição 1 e o primeiro na posição 2.
